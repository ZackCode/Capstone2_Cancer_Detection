...
# # Machine Learning Part 1.6: Testing Data Processing
# 
# This file is get the data ready for testing the CNN algorithm
# 
# No limitation is placed on this one because I have to make a submission to kaggle to see how well the result is ... cool, it roughly took me 2 days to run, good luck!
